  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: "vertualScroll",
        component: () => import("../views/main/vertualScroll/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
        ...
        path: "transfer",
        component: () => import("../views/main/transfer/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
        ...
        path: "colorPicker",
        component: () => import("../views/main/colorPicker/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
        ...
        path: "dropdown",
        component: () => import("../views/main/dropdown/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
        ...
        path: "carousel",
        component: () => import("../views/main/carousel/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
        ...
        path: "alert",
        component: () => import("../views/main/alert/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
        ...
        path: "watermark",
        component: () => import("../views/main/watermark/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
        ...
        path: "tab",
        component: () => import("../views/main/tab/index.vue"),
        meta: {
          aside: [{
            href: "#",
            name: "中年"
